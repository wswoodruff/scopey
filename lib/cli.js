...
internals.commandArgs = {
    biz: internals.commandDescription('Subcommands: priorities'),
    debt: internals.commandDescription('Subcommands: manage, analyze'),
    scope: internals.commandDescription('Walk through scoping questions that promote best practices')
};
